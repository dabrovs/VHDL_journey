...
-- ========================================================
-- Takes 4bit input (interpret as hex code) and converts it to 8bit string to display hex code on 7seg display
LIBRARY IEEE;
...
ENTITY hex_decoder IS 
	PORT(
		binary_in_4b   : IN  STD_LOGIC_VECTOR (3 DOWNTO 0); -- Data in hex to be displayed
		seven_sgmt_out : OUT STD_LOGIC_VECTOR (7 DOWNTO 0)	 -- Bitstring for 7seg
	);
END hex_decoder;
